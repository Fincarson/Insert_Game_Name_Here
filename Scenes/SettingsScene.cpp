...
void SettingsScene::Initialize() {
    ...
    // Back Button
    btn = new Engine::ImageButton("stage-select/button.png", "stage-select/button_hovered.png", halfW - 200, halfH * 3 / 2 - 50, 400, 100);
    btn->SetOnClickCallback(std::bind(&SettingsScene::BackOnClick, this, 1));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW, halfH * 3 / 2 + 5 + 3, 0, 0, 100, 255, 0.5, 0.5));
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW, halfH * 3 / 2 + 5 - 2, 255, 255, 255, 255, 0.5, 0.5));
